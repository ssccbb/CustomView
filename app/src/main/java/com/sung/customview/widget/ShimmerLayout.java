...
public class ShimmerLayout extends FrameLayout {
    ...
    private static class Mask {
        ...
        public int[] getGradientColors() {
            switch (shape) {
                default:
                case LINEAR:
                    return new int[]{Color.WHITE ,Color.TRANSPARENT, Color.TRANSPARENT , Color.WHITE};
                case RADIAL:
    ...
    public ShimmerLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ShimmerLayout, 0, 0);
            try {
                if (a.hasValue(R.styleable.ShimmerLayout_auto_start)) {
                    setAutoStart(a.getBoolean(R.styleable.ShimmerLayout_auto_start, false));
                }
                if (a.hasValue(R.styleable.ShimmerLayout_base_alpha)) {
                    setBaseAlpha(a.getFloat(R.styleable.ShimmerLayout_base_alpha, 0));
                }
                if (a.hasValue(R.styleable.ShimmerLayout_duration)) {
                    setDuration(a.getInt(R.styleable.ShimmerLayout_duration, 0));
                }
                if (a.hasValue(R.styleable.ShimmerLayout_repeat_count)) {
                    setRepeatCount(a.getInt(R.styleable.ShimmerLayout_repeat_count, 0));
                }
                if (a.hasValue(R.styleable.ShimmerLayout_repeat_delay)) {
                    setRepeatDelay(a.getInt(R.styleable.ShimmerLayout_repeat_delay, 0));
                }
                if (a.hasValue(R.styleable.ShimmerLayout_repeat_mode)) {
                    setRepeatMode(a.getInt(R.styleable.ShimmerLayout_repeat_mode, 0));
                }

                if (a.hasValue(R.styleable.ShimmerLayout_angle)) {
                    int angle = a.getInt(R.styleable.ShimmerLayout_angle, 0);
                    switch (angle) {
                        default:
                        case 0:
                ...
                if (a.hasValue(R.styleable.ShimmerLayout_shape)) {
                    int shape = a.getInt(R.styleable.ShimmerLayout_shape, 0);
                    switch (shape) {
                        default:
                        case 0:
                ...
                if (a.hasValue(R.styleable.ShimmerLayout_dropoff)) {
                    mMask.dropoff = a.getFloat(R.styleable.ShimmerLayout_dropoff, 0);
                }
                if (a.hasValue(R.styleable.ShimmerLayout_fixed_width)) {
                    mMask.fixedWidth = a.getDimensionPixelSize(R.styleable.ShimmerLayout_fixed_width, 0);
                }
                if (a.hasValue(R.styleable.ShimmerLayout_fixed_height)) {
                    mMask.fixedHeight = a.getDimensionPixelSize(R.styleable.ShimmerLayout_fixed_height, 0);
                }
                if (a.hasValue(R.styleable.ShimmerLayout_intensity)) {
                    mMask.intensity = a.getFloat(R.styleable.ShimmerLayout_intensity, 0);
                }
                if (a.hasValue(R.styleable.ShimmerLayout_relative_width)) {
                    mMask.relativeWidth = a.getFloat(R.styleable.ShimmerLayout_relative_width, 0);
                }
                if (a.hasValue(R.styleable.ShimmerLayout_relative_height)) {
                    mMask.relativeHeight = a.getFloat(R.styleable.ShimmerLayout_relative_height, 0);
                }
                if (a.hasValue(R.styleable.ShimmerLayout_tilt)) {
                    mMask.tilt = a.getFloat(R.styleable.ShimmerLayout_tilt, 0);
                }
            } finally {
                a.recycle();
            }
...
//        renderCanvas.drawColor(Color.YELLOW);
    ...
    private void drawMasked(Canvas renderCanvas) {
        ...
        renderCanvas.drawColor(Color.WHITE, PorterDuff.Mode.CLEAR);
//        renderCanvas.drawColor(Color.BLUE);
        super.dispatchDraw(renderCanvas);
