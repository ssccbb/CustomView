...
import com.sung.customview.Utils;
import java.util.ArrayList;
import java.util.Iterator;
import java.util.List;

/**
 * Created by sung on 2017/3/24.
 * 圆形水波纹扩散
 */

public class WaveView extends View {
    private float mInitialRadius = Utils.dip2px(getContext(),45);   // 初始波纹半径
    private float mMaxRadiusRate = 0.85f;   // 如果没有设置mMaxRadius，可mMaxRadius = 最小长度 * mMaxRadiusRate;
    private float mMaxRadius = Utils.dip2px(getContext(),75);   // 最大波纹半径
    private long mDuration = 2400; // 一个波纹从创建到消失的持续时间
